                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add New Skill <router-link to="/skills"><button class="btn btn-success">Go Back</button></router-link></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" @submit.prevent="addskillSection()">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="percent">Add Percent(0 to 100)</label>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="value">Add Value(0 to 100)</label>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="value">Add Status(active or inactive)</label>
...
name: "Add",
    ...
    methods:{
        addskillSection(){
            ...
            this.form.post('/add-skill')
                .then(( response ) => {
                    this.$router.push('/skills')
                    toast.fire({
                        icon: 'success',
                        title: 'Yah! A Skill Has Been successfully Added'
                    })
                }).catch(()=>{
