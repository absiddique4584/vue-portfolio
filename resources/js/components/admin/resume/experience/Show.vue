                            ...
                            <form >
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" v-model="form.rank" name="rank" class="form-control" id="rank"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" v-model="form.year" name="year" class="form-control" id="year"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" v-model="form.work_place" name="versity" class="form-control" id="work_place"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <textarea readonly name="work1" id="work1" v-model="form.work1" cols="30" class="form-control"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <textarea readonly name="work2" id="work2" v-model="form.work2" cols="30" class="form-control"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <textarea readonly name="work3" id="work3" v-model="form.work3" cols="30" class="form-control"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <textarea readonly name="work4" id="work4" v-model="form.work4" cols="30" class="form-control"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" v-model="form.status" name="status" class="form-control" id="status"
...
name: "Show",
    mounted(){
        axios.get(`/resume/experience/show/${this.$route.params.experience_showID}`)
            .then((response)=>{
