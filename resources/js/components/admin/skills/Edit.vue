                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Update Skill <router-link to="/skills"><button class="btn btn-success">Go Back</button></router-link></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" @submit.prevent="updateskill()">
...
name: "Edit",
    ...
    mounted() {
        axios.get(`/editSkill/${this.$route.params.skillID}`)
            .then((response)=>{
                this.form.fill(response.data.skills)
            })
    },
    methods:{
        updateskill(){
            this.form.post(`/update-skill/${this.$route.params.skillID}`)
                .then((response)=>{
