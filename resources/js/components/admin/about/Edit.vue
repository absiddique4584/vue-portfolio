                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add New About <router-link to="/abouts"><button class="btn btn-success">Go Back</button></router-link></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" @submit.prevent="updateAbout()" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" v-model="form.birth" name="birth" class="form-control" id="birth"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" v-model="form.age" name="age" class="form-control" id="age"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" v-model="form.site" name="site" class="form-control" id="site"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" v-model="form.address" name="address" class="form-control" id="address"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="degree">Education Qualification</label>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" v-model="form.country" name="country" class="form-control" id="country"
...
name: "Edit",
    mounted() {
        axios.get(`/edit-about/${this.$route.params.aboutID}`)
            .then((response)=>{
        ...
        updateAbout(){
            this.form.post(`update-about/${this.$route.params.aboutID}`)
                .then(()=>{
                    ...
                    toast.fire({
                        icon: 'success',
                        title: 'Yah! A About Updated successfully'
                    })
                })
                .catch(()=>{
